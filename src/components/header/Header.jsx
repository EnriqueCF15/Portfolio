...
import "../../hoverParticles/hoverParticles";

// import Blast from "../BlastAnimation/Blast";
import BlastV from "../BlastAnimation/BlastV2";
// import Logo from '../logoAnimation/Logo'
import "./header.scss";

const introArray = ["H", "i", ","];
const nameArray = ["I","´","m","","","E","n","r","i","q","u","e",","]
    ...
    <>
      ...
      <section className="section-1 header__container section__padding">
        <main className="intro-page">
          <h1 arial-label="Hi i'm Enrique, web Junior full-stack developer">
